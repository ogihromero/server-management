...
import com.example.servermanagement.service.implementation.ServerServiceImplementation;
...
public class ServerResource {
    ...
    public ResponseEntity<Response> getServers() {
        return ResponseEntity.ok(Response.builder().timeStamp(now())
                ...
                .message("Servidores recuperados").status(OK)
                .statusCode(OK.value())
                .build());
    }
    ...
    public ResponseEntity<Response> pingServer(@PathVariable("ipAddress") String ipAddress) throws IOException {
        ...
        return ResponseEntity.ok(
                Response.builder()
                        ...
                        .message(server.getStatus() == SERVER_UP ? "Ping realizado com sucesso" : "Falha no teste de ping")
                        .status(OK)
                        .statusCode(OK.value())
                        .build()
        );
